...
public class NewsActivity extends AppCompatActivity
    ...
    public Loader<List<News>> onCreateLoader(int i, Bundle bundle) {
        ...
        // Append query parameter and its value. For example, the `search=Queen`
        uriBuilder.appendQueryParameter("q", search);
        uriBuilder.appendQueryParameter("section", section);
        uriBuilder.appendQueryParameter("api-key", "92adef8b-3472-4289-96b0-37c2f2ba762c");
        Log.v("MyActivity", uriBuilder.toString());
        // Return the completed uri `https://content.guardianapis.com/search?q=Messi&sectionId=sports&api-key=92adef8b-3472-4289-96b0-37c2f2ba762c
